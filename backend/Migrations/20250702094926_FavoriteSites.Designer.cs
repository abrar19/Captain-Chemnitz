...
namespace backend.Migrations
{
    ...
    [Migration("20250702094926_FavoriteSites")]
    partial class FavoriteSites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Entity.FavoriteSiteModel", b =>
                {
                    ...
                    b.Property<string>("CulturalSiteId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CulturalSiteId1");

                    b.HasIndex("userEmail");

                    b.ToTable("FavoriteSiteModel");
                });
            ...
            modelBuilder.Entity("backend.Models.Entity.FavoriteSiteModel", b =>
                {
                    b.HasOne("backend.Models.Entity.CulturalSiteModel", "CulturalSite")
                        .WithMany()
                        .HasForeignKey("CulturalSiteId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
